...
FROM --platform=${BUILDPLATFORM} rust:1.98.0-slim-trixie@sha256:fb4b2f1dc68c06f46618948b09d0ade147e6d2b11a6581e599b0c808d5b8a167 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.8.1-alpine3.24@sha256:2d984a15c9b54fd0aeb608b8e0d0d83529eb34d2966db27a1fb4f1edc3d298a3 AS typescript-build
