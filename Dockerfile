...
FROM --platform=${BUILDPLATFORM} rust:1.96.0-slim-trixie@sha256:4ddd2ebb0043566905e1e5e82ba7c66c03444b32ef16caa6bf5a20155d6ffb15 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.3.1-alpine3.24@sha256:a2dc166a387cc6ca1e62d0c8e265e49ca985d6e60abc9fe6e6c3d6ce8e63f606 AS typescript-build
