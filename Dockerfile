...
FROM --platform=${BUILDPLATFORM} rust:1.98.1-slim-trixie@sha256:60c65b68b47b7ff43a3454c86d7ca8f7f353cf5741fd980256d156c60deca6f5 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.9.0-alpine3.24@sha256:dbaa92e5758cbbcf85d65d5403fdb530fe3442cbe8c6dbfb7ef23365450d5070 AS typescript-build
