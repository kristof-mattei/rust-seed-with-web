...
FROM --platform=${BUILDPLATFORM} rust:1.96.0-slim-trixie@sha256:a818c23087b65be495e78fa329d577481e7700748bb2d1f28658b6bce3c7b931 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.3.0-alpine3.23@sha256:144769ec3f32e8ee36b3cfde91e82bee25d9367b20f31a151f3f7eea3a2a8541 AS typescript-build
...
FROM --platform=${BUILDPLATFORM} alpine:3.24.0@sha256:a2d49ea686c2adfe3c992e47dc3b5e7fa6e6b5055609400dc2acaeb241c829f4 AS passwd-build
