...
FROM --platform=${BUILDPLATFORM} rust:1.97.0-slim-trixie@sha256:41a5647cbdc067365b49e71f6a416789ab2ff884e501577643de6e99cb11b61d AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.5.0-alpine3.24@sha256:e88a35be04478413b7c71c455cd9865de9b9360e1f43456be5951032d7ac1a66 AS typescript-build
