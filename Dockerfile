...
FROM --platform=${BUILDPLATFORM} rust:1.96.0-slim-trixie@sha256:6abf73f05806f36362d0ff2722f2250c6153398831edd0455e0e0baa1f78ecc7 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.4.0-alpine3.24@sha256:725aeba2364a9b16beae49e180d83bd597dbd0b15c47f1f28875c290bfd255b9 AS typescript-build
