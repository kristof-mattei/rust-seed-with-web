...
FROM --platform=${BUILDPLATFORM} rust:1.94.1-slim-trixie@sha256:cf09adf8c3ebaba10779e5c23ff7fe4df4cccdab8a91f199b0c142c53fef3e1a AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:24.15.0-alpine3.22@sha256:c58db688e29a231f8ea3fc842f06bd4709ee4c6cf2a615ffc25e6abf694749fa AS typescript-build
