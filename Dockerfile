...
FROM --platform=${BUILDPLATFORM} rust:1.98.0-slim-trixie@sha256:cc0448b41c3b7b7fea44f5dc50eacba729a56db365b65b7bd5e8a82d5b3db078 AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.7.0-alpine3.24@sha256:aadf416b2cdce311a8811ba3f0608a61b77dbf997500e2eafe781b51f6a0b019 AS typescript-build
